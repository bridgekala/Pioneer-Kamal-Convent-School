                                ...
                                <nav class="navigation__menu">
                                        ...
                                        <li class="navigation__menu--item has-child">
                                            ...
                                            <ul class="submenu sub__style">
                                                ...
                                                <li><a href="{{ route('Infrastructure') }}#computer-lab">Computer
                                                        Lab</a></li>
                                                <li><a href="{{ route('Infrastructure') }}#composite-science-lab">Composite
                                                        Science Lab</a></li>
                                                <li><a href="{{ route('Infrastructure') }}#auditorium">Auditorium
                                                    </a></li>
                                        </li>
                                    ...
                                    <div style="display: flex; align-item:center; justify-content:center;"
                                        ...
                                        <a style="width: 100%;" href="{{ route('index') }}" class="header__logo--link">
                                            <img style="width: 100%;" src="{{ asset('assets/images/logo/logo.png') }}"
                                                alt="unipix">
                                        </a>
                                    </div>
                                    ...
                                    <li class="navigation__menu--item has-child">
                                        ...
                                        <ul class="submenu sub__style">
                                            <li><a href="{{ route('mandatory-public-disclosure') }}">Mandatory
                                                    Public Disclosure</a></li>
                                            <li><a href="{{ route('saras-mandatory-disclosure') }}">SARAS-Mandatory
                                                    Disclosure</a>
                                            </li>
                                        </ul>
                                    </li>
